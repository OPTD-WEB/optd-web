    ...
    <div class="navbar-content px-4 py-3 flex items-center justify-between h-full max-w-[1920px] mx-auto">
        <div class="navbar-left flex items-center gap-5">
            <div class="logo flex items-center gap-2">
                <img src="${pageContext.request.contextPath}/assets/images/optd_main_logo.png" alt="homeLogo" class="w-[150px] h-[70px]">
            </div>
        ...
        <div class="auth-buttons flex gap-2">
            <button class="btn-login bg-white text-black py-[6px] px-4 rounded-md border-none text-sm tracking-[-0.1504px] leading-5 cursor-pointer transition-opacity duration-300 hover:opacity-90">로그인</button>
            <button class="btn-signup bg-transparent text-white py-[7px] px-[17px] rounded-md border border-white text-sm tracking-[-0.1504px] leading-5 cursor-pointer transition-colors duration-300 hover:bg-[rgba(255,255,255,0.1)]">회원가입</button>
        </div>
    </div>
